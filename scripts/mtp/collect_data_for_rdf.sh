...
rm trajes_for_rdf/trajectory_mtp_$1_$2.lammpstrj.gz
...
dump traj all custom 20 trajes_for_rdf/trajectory_mtp_$1_$2.lammpstrj.gz id type x y z
...
mpirun -n 10 ./lmp_mpi -in temp_scripts/collect_data_for_rdf_$1_$2.lammps
EOF
